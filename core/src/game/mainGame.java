...
public class mainGame extends ApplicationAdapter {
    ...
    public void loadLevel(String level){
        ...
        FileHandle file = Gdx.files.internal("res/data/" + level + ".txt");
    ...
    public void mainGame(){
        ...
        for(GameObject t : enemies){
            if(t.getHitBox() != null && t.getHitBox().overlaps(screen)){
                t.draw(batch);
            }
        }
    ...
    public void generateCoins(){
		...
		try {
		    out = new PrintWriter(new BufferedWriter(new FileWriter("C:/Users/Deividas/Downloads/studying/core/bin/res/data/level1.txt", true)));
		   // out.println();
		    for(int i=0; i<10; i++){
